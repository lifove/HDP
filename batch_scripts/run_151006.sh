# conduct experiments using ks (R) for probability distrubtions of source and target datasets

date=20151006
postfix=_fs_s15 #rf15
cofeature_prefix=20150326_FS_S15 # 20150213_FS_NONE #20150210_FS_Shiv_RF15 #20150610_FS_S15
server=`hostname`
numOfThreads=4
saveNewData=false
fsOption=shiv_s0.15 #none #shiv_rf0.15 #gr0.15 # none acc auc f-meas
verbose=false
...
algorithms="weka.classifiers.functions.Logistic" #weka.classifiers.trees.LMT"
...
libs=":/home/j22nam/Documents/mybin/JCTools/dist/JCTools.jar:bin/CrossPredictionSimulator/CrossPredictionSimulator/lib/*:/home/j22nam/Documents/mybin/JCTools/lib/*"
...
#done
cutoffs="0.05" #0.10 0.50 0.80 0.90" # 0.10 0.20 0.30 0.40 0.50 0.60 0.70 0.80 0.90"
...
#grep ^\[TA\] Results/$server/$date$postfix\_$folds.txt > Results/$server/$date$postfix\_$folds.txt\_A.txt
