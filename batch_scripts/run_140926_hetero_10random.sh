date=20141013
postfix=_hetero_10random
cofeature_prefix=20140925_HETRO_10Random
server=`hostname`
numOfThreads=1
saveNewData=false
verbose=true
...
java -Xmx13524m -cp  bin/CrossPredictor_hetero_random.jar$libs hk.ust.cse.ipam.jc.crossprediction.Driver $numOfThreads $saveNewData $cofeature_prefix\_$cutoff.txt $analyzers $cutoff $cutoff 0.05 $algorithms $verbose >> Results/$server/$date$postfix.txt 
