...
rawdata=skcpu6/20141013_no_filter_hetro.txt

#for algorithm in $algorithms
#do
	java -Xmx13524m -cp  bin/CrossPredictor.jar$libs hk.ust.cse.ipam.jc.crossprediction.util.WinTieLossByUtest Results/$rawdata > Results/$server/20141013_wintieloss_hetro.txt
#done
